...
public class loginVew extends javax.swing.JFrame {
    ...
    private void btnConActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConActionPerformed
        ...
        if (loginController.checkLogin(obj)) {
           ...
           new java.util.Timer().schedule(new TimerTask() {
            ...
            Notification notify = new Notification(this, Notification.Type.WARNING, Notification.Location.TOP_RIGHT, "Username or Password is Incorrect!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginVew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
